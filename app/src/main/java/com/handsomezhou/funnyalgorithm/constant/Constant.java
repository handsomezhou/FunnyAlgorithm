...
package com.handsomezhou.funnyalgorithm.constant;
...
public interface Constant {
    ...
    /* end: int */
    /* start: Double */
    public static final double ZERO_OF_DOUBLE_BOUNDARY = 0.000001;
    public static final double ZERO_OF_DOUBLE = 0.0;

    /* end: Double */
    /* start: long */
    public static final long ZERO_OF_LONG = 0;
    /* end: long */
}
